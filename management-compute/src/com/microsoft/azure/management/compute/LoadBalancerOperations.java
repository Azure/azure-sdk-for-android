...
public interface LoadBalancerOperations {
    ...
    */
    OperationStatusResponse beginCreating(String serviceName, String deploymentName, LoadBalancerCreateParameters parameters) throws MalformedURLException, ProtocolException, ServiceException, IOException;
    ...
    * the failed request and error information regarding the failure.
    */
    OperationStatusResponse beginDeleting(String serviceName, String deploymentName, String loadBalancerName) throws MalformedURLException, ProtocolException, ServiceException, IOException;
    ...
    * request ID.
    */
    OperationResponse delete(String serviceName, String deploymentName, String loadBalancerName) throws MalformedURLException, ProtocolException, ServiceException, IOException, InterruptedException, ExecutionException;
