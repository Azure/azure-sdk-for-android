...
public final class IndividualStatusResponse {
    ...
    /**
     * Get the id property: Identifies the resource to which the individual
     * status corresponds.
     * 
     * @return the id value.
     */
    ...
    /**
     * Get the message property: The message explaining why the operation
     * failed for the resource identified by the key; null if the operation
     * succeeded.
     * 
    ...
    /**
     * Get the type property: Identifies the type of the resource to which the
     * individual status corresponds.
     * 
