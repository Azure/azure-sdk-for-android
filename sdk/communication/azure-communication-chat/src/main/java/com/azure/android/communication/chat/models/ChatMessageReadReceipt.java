...
public final class ChatMessageReadReceipt {
     ...
     */
    public ChatMessageReadReceipt setSenderId(CommunicationUserIdentifier senderId) {
        this.senderId = senderId;
        return this;
    }

    /**
     * Get the chatMessageId property: Id of the chat message that has been
    ...
    /**
     * Set the chatMessageId property: Id of the chat message that has been
     * read. This id is generated by the server.
     *
    ...
    /**
     * Get the readOn property: The time at which the message was read. The
    ...
    /**
     * Set the readOn property: The time at which the message was read. The
     * timestamp is in RFC3339 format: `yyyy-MM-ddTHH:mm:ssZ`.
     *
