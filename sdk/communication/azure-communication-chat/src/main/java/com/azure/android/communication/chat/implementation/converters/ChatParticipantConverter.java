...
public final class ChatParticipantConverter {
     ...
     */
    public static ChatParticipant convert(com.azure.android.communication.chat.implementation.models.ChatParticipant obj) {
        if (obj == null) {
            return null;
        }
     ...
     */
    public static com.azure.android.communication.chat.implementation.models.ChatParticipant convert(ChatParticipant obj) {
        if (obj == null) {
            return null;
        }
