...
import com.azure.android.communication.chat.handwritten.implementation.converters.CreateChatThreadResultConverter;
...
import com.azure.android.communication.chat.handwritten.implementation.converters.ChatThreadConverter;
import com.azure.android.communication.chat.handwritten.implementation.converters.CreateChatThreadOptionsConverter;
...
public final class ChatAsyncClient {
    ...
    Mono<Response<ChatThread>> getChatThread(String chatThreadId, Context context) {
        ...
        return this.chatClient.getChatThreadWithResponseAsync(chatThreadId, context)
            .flatMap(
                (Response<com.azure.android.communication.chat.implementation.models.ChatThread> res) -> {
