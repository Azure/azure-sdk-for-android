...
import com.azure.android.communication.chat.handwritten.implementation.ChatOptionsProvider;
...
public class ChatThreadAsyncClientTest extends ChatClientTestBase {
    ...
    public void canAddListWithContextAndRemoveMembersAsync(HttpClient httpClient) throws InterruptedException {
        ...
        // Act & Assert
        PagedFlux<ChatParticipant> membersResponse = chatThreadClient.listParticipants(new ListParticipantsOptions());
    ...
    public void canAddListWithContextMembersAsync(HttpClient httpClient) throws InterruptedException {
        ...
        StepVerifier.create(chatThreadClient.addParticipants(options))
            .assertNext(noResp -> {
                PagedIterable<ChatParticipant> membersResponse = new PagedIterable<>(chatThreadClient.listParticipants(new ListParticipantsOptions()));
    ...
    public void canListReadReceiptsWithContext(HttpClient httpClient) {
        ...
        setupUnitTest(mockHttpClient);
        PagedFlux<ChatMessageReadReceipt> readReceipts = chatThreadClient.listReadReceipts(new ListReadReceiptOptions());
