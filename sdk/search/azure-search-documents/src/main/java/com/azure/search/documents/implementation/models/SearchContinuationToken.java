...
public final class SearchContinuationToken {
    ...
    public static String serializeToken(String apiVersion, String nextLink, SearchRequest nextPageParameters) {
        ...
        try {
            nextParametersString = new JacksonSerderAdapter().serialize(nextPageParameters, SerdeEncoding.JSON);
    ...
    public static SearchRequest deserializeToken(String apiVersion, String continuationToken) {
        try {
            ...
            return new JacksonSerderAdapter().deserialize(tokenFields.get(NEXT_PAGE_PARAMETERS),
                SearchRequest.class, SerdeEncoding.JSON);
        } catch (IOException e) {
