...
public final class SuggestRequest {
     ...
     */
    @SerdeProperty(value = "suggesterName")
    ...
    public SuggestRequest(
            @SerdeProperty(value = "search") String searchText,
            @SerdeProperty(value = "suggesterName") String suggesterName) {
