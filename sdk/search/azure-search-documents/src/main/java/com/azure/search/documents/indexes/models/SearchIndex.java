...
public final class SearchIndex {
     ...
     */
    @SerdeProperty(value = "fields")
    private List<SearchField> fields;

    /*
     * The scoring profiles for the index.
     */
    @SerdeProperty(value = "scoringProfiles")
     ...
     */
    @SerdeProperty(value = "similarity")
    ...
    public SearchIndex(
        ...
        @SerdeProperty(value = "fields") List<SearchField> fields) {
        this.name = name;
        this.fields = fields;
    }
