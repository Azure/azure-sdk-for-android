...
@SerdeTypeName("#Microsoft.Skills.Text.EntityRecognitionSkill")
@Fluent
public final class EntityRecognitionSkill extends SearchIndexerSkill {
    /*
     * A list of entity categories that should be extracted.
     */
    @SerdeProperty(value = "categories")
     ...
     */
    @SerdeProperty(value = "includeTypelessEntities")
     ...
     */
    @SerdeProperty(value = "minimumPrecision")
