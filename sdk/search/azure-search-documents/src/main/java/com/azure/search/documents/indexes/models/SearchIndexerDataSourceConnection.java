...
public final class SearchIndexerDataSourceConnection {
    ...
    public SearchIndexerDataSourceConnection(
        ...
        @SerdeProperty(value = "type") SearchIndexerDataSourceType type,
        @SerdeProperty(value = "credentials") String connectionString,
        @SerdeProperty(value = "container") SearchIndexerDataContainer container) {
        this.name = name;
        this.type = type;
