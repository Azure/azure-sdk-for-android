...
public final class SearchField {
     ...
     */
    @SerdeProperty(value = "searchable")
     ...
     */
    @SerdeProperty(value = "filterable")
     ...
     * 'Simple', 'Stop', 'Whitespace'
     */
    @SerdeProperty(value = "searchAnalyzer")
     ...
     * 'Whitespace'
     */
    @SerdeProperty(value = "indexAnalyzer")
    ...
    public SearchField(
        ...
        @SerdeProperty(value = "type") SearchFieldDataType type) {
        this.name = name;
        this.type = type;
    }
