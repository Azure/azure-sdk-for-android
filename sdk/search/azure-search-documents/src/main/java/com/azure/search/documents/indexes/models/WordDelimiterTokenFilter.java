...
@SerdeTypeName("#Microsoft.Azure.Search.WordDelimiterTokenFilter")
@Fluent
public final class WordDelimiterTokenFilter extends TokenFilter {
     ...
     */
    @SerdeProperty(value = "catenateWords")
     ...
     * Default is false.
     */
    @SerdeProperty(value = "catenateNumbers")
     ...
     */
    @SerdeProperty(value = "catenateAll")
     ...
     * true.
     */
    @SerdeProperty(value = "splitOnCaseChange")
     ...
     * true.
     */
    @SerdeProperty(value = "splitOnNumerics")
