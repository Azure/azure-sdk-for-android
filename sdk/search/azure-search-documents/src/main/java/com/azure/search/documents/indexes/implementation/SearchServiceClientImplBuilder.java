...
public final class SearchServiceClientImplBuilder {
     ...
     */
    private SerdeAdapter serdeAdapter;

    /**
     * Sets The serializer to serialize an object into a string.
     *
     * @param serdeAdapter the serializerAdapter value.
     * @return the SearchServiceClientImplBuilder.
     */
    public SearchServiceClientImplBuilder serializerAdapter(SerdeAdapter serdeAdapter) {
    ...
    public SearchServiceClientImpl buildClient() {
        ...
        if (serdeAdapter == null) {
            this.serdeAdapter = JacksonSerderAdapter.createDefaultSerdeAdapter();
        }
        SearchServiceClientImpl client = new SearchServiceClientImpl(pipeline, serdeAdapter, endpoint);
        return client;
    }
    ...
    private HttpPipeline createHttpPipeline() {
        ...
        policies.add(
                new UserAgentPolicy(null/*TODO (anuchan) httpLogOptions.getApplicationId()*/, clientName, clientVersion, buildConfiguration));
