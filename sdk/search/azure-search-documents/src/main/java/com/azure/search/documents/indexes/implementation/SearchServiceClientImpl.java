...
public final class SearchServiceClientImpl {
     ...
     */
    public SerdeAdapter getSerdeAdapter() {
        return this.serdeAdapter;
    }
    ...
    SearchServiceClientImpl(String endpoint) {
        this(
                new HttpPipelineBuilder()
                        ...
                        .build(),
                JacksonSerderAdapter.createDefaultSerdeAdapter(),
                endpoint);
    }
    ...
    SearchServiceClientImpl(HttpPipeline httpPipeline, String endpoint) {
        this(httpPipeline, JacksonSerderAdapter.createDefaultSerdeAdapter(), endpoint);
    }
     ...
     *
     * @param httpPipeline The HTTP pipeline to send requests through.
     * @param serdeAdapter The serializer to serialize an object into a string.
     * @param endpoint The endpoint URL of the search service.
     */
    SearchServiceClientImpl(HttpPipeline httpPipeline, SerdeAdapter serdeAdapter, String endpoint) {
        ...
        this.service =
                RestProxy.create(SearchServiceClientService.class, this.httpPipeline, this.getSerdeAdapter());
    }
