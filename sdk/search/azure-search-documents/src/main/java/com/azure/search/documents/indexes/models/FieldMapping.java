...
public final class FieldMapping {
     ...
     */
    @SerdeProperty(value = "sourceFieldName")
     ...
     * by default.
     */
    @SerdeProperty(value = "targetFieldName")
    private String targetFieldName;

    /*
     * A function to apply to each source field value before indexing.
     */
    @SerdeProperty(value = "mappingFunction")
     ...
     */
    @SerdeToPojo
    public FieldMapping(@SerdeProperty(value = "sourceFieldName") String sourceFieldName) {
