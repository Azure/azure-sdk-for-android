...
@SerdeTypeName("#Microsoft.Azure.Search.DictionaryDecompounderTokenFilter")
@Fluent
public final class DictionaryDecompounderTokenFilter extends TokenFilter {
    /*
     * The list of words to match against.
     */
    @SerdeProperty(value = "wordList")
     ...
     */
    @SerdeProperty(value = "minWordSize")
     ...
     */
    @SerdeProperty(value = "minSubwordSize")
     ...
     */
    @SerdeProperty(value = "maxSubwordSize")
     ...
     */
    @SerdeProperty(value = "onlyLongestMatch")
