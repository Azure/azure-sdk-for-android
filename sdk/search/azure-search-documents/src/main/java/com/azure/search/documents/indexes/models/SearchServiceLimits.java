...
public final class SearchServiceLimits {
     ...
     */
    @SerdeProperty(value = "maxFieldsPerIndex")
     ...
     * 3.
     */
    @SerdeProperty(value = "maxFieldNestingDepthPerIndex")
     ...
     * in an index.
     */
    @SerdeProperty(value = "maxComplexCollectionFieldsPerIndex")
     ...
     * document.
     */
    @SerdeProperty(value = "maxComplexObjectsInCollectionsPerDocument")
