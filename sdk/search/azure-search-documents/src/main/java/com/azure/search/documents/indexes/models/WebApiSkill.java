...
@SerdeTypeName("#Microsoft.Skills.Custom.WebApiSkill")
@Fluent
public final class WebApiSkill extends SearchIndexerSkill {
    /*
     * The url for the Web API.
     */
    @SerdeProperty(value = "uri")
    private String uri;

    /*
     * The headers required to make the http request.
     */
    @SerdeProperty(value = "httpHeaders")
    private Map<String, String> httpHeaders;

    /*
     * The method for the http request.
     */
    @SerdeProperty(value = "httpMethod")
    private String httpMethod;

    /*
     * The desired timeout for the request. Default is 30 seconds.
     */
    @SerdeProperty(value = "timeout")
    private Duration timeout;

    /*
     * The desired batch size which indicates number of documents.
     */
    @SerdeProperty(value = "batchSize")
    private Integer batchSize;

    /*
     * If set, the number of parallel calls that can be made to the Web API.
     */
    @SerdeProperty(value = "degreeOfParallelism")
