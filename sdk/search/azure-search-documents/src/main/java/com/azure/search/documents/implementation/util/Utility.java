...
import com.azure.core.micro.util.ClientOptions;
...
public final class Utility {
    ...
    static {
        // TODO (anuchan) Map<String, String> properties = CoreUtils.getProperties("azure-search-documents.properties");
        CLIENT_NAME = "UnknownName"; // properties.getOrDefault("name", "UnknownName");
        CLIENT_VERSION = "UnknownVersion"; // properties.getOrDefault("version", "UnknownVersion");
    }
     ...
     */
    public static SerdeAdapter initializeSerdeAdapter() {
