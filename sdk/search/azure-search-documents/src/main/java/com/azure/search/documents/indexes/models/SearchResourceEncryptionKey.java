...
public final class SearchResourceEncryptionKey {
     ...
     * rest.
     */
    @SerdeProperty(value = "keyVaultKeyName")
     ...
     * at rest.
     */
    @SerdeProperty(value = "keyVaultKeyVersion")
     ...
     */
    @SerdeProperty(value = "keyVaultUri")
     ...
     */
    @SerdeProperty(value = "applicationId")
    private String applicationId;

    /*
     * The authentication key of the specified AAD application.
     */
    @SerdeProperty(value = "applicationSecret")
    ...
    public SearchResourceEncryptionKey(
        @SerdeProperty(value = "keyVaultKeyName") String keyName,
        @SerdeProperty(value = "keyVaultKeyVersion") String keyVersion,
        @SerdeProperty(value = "keyVaultUri") String vaultUrl) {
