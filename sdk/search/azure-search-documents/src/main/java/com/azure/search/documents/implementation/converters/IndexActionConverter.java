...
public final class IndexActionConverter {
    ...
    public static <T> com.azure.search.documents.implementation.models.IndexAction map(IndexAction<T> obj,
        ...
        if (mapProperties == null) {
            ...
            if (serializer == null) {
                try {
                    String serializedJson = SEARCH_JACKSON_SERDER_ADAPTER.serialize(properties, SerdeEncoding.JSON);
                    mapProperties =
                        SEARCH_JACKSON_SERDER_ADAPTER.deserialize(serializedJson, MAP_STRING_OBJECT_TYPE_REFERENCE.getJavaType(),
                            SerdeEncoding.JSON);
