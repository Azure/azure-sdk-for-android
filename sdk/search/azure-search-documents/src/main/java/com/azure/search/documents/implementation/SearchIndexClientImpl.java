...
public final class SearchIndexClientImpl {
    ...
    SearchIndexClientImpl(HttpPipeline httpPipeline, String endpoint, String indexName) {
        this(httpPipeline, JacksonSerderAdapter.createDefaultSerdeAdapter(), endpoint, indexName);
    }
    ...
    SearchIndexClientImpl(
        HttpPipeline httpPipeline, SerdeAdapter serdeAdapter, String endpoint, String indexName) {
