...
public final class SearchIndexClientImplBuilder {
     ...
     * @return the SearchIndexClientImplBuilder.
     */
    public SearchIndexClientImplBuilder serdeAdapter(SerdeAdapter serdeAdapter) {
    ...
    public SearchIndexClientImpl buildClient() {
        ...
        SearchIndexClientImpl client = new SearchIndexClientImpl(pipeline, serdeAdapter, endpoint, indexName);
        return client;
    }
