...
public final class ShingleTokenFilter extends TokenFilter {
     ...
     */
    @SerdeProperty(value = "minShingleSize")
     ...
     */
    @SerdeProperty(value = "outputUnigramsIfNoShingles")
     ...
     */
    @SerdeProperty(value = "tokenSeparator")
     ...
     */
    @SerdeProperty(value = "filterToken")
