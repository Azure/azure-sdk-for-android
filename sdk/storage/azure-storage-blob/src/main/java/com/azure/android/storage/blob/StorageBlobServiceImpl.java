...
class StorageBlobServiceImpl {
    ...
    StorageBlobServiceImpl(RestAPIClient restAPIClient) {
        this.service = restAPIClient.createServiceClient(StorageBlobService.class);
        this.serializerAdapter = restAPIClient.getSerializerAdapter();
    }
