...
import com.azure.android.storage.blob.transfer.ResumeRequest;
...
public class StorageBlobClient {
    ...
    public TransferTask upload(Context context,
        ...
        final UploadRequest request = new UploadRequest.Builder()
            ...
            .build();
        return new TransferTask(TransferClient.getInstance(context), request);
    }
    ...
    public TransferTask resume(Context context, String transferId) {
        final ResumeRequest request = new ResumeRequest.Builder()
     ...
     */
    public ServiceCallTask<List<BlobItem>> getBlobsInPage(String pageId,
                                         String containerName,
     ...
     */
    public ServiceCallTask<ContainersListBlobFlatSegmentResponse> getBlobsInPageWithRestResponse(String pageId,
                                                                                String containerName,
                                                                                String prefix,
                                                                                Integer maxResults,
     ...
     */
    public ServiceCallTask<BlobGetPropertiesHeaders> getBlobProperties(String containerName,
                                                      String blobName) {
     ...
     */
    public ServiceCallTask<BlobGetPropertiesResponse> getBlobPropertiesWithRestResponse(String containerName,
                                                                       String blobName,
                                                                       String snapshot,
                                                                       Integer timeout,
                                                                       String version,
     ...
     */
    public ServiceCallTask<ResponseBody> rawDownload(String containerName,
                                    String blobName) {
     ...
     * @return The response information returned from the server when downloading a blob.
     */
    public ServiceCallTask<BlobDownloadResponse> rawDownloadWithRestResponse(String containerName,
                                                            String blobName,
                                                            String snapshot,
                                                            Integer timeout,
                                                            BlobRange range,
     ...
     */
    public ServiceCallTask<Void> stageBlock(String containerName,
                           String blobName,
     ...
     */
    public ServiceCallTask<BlockBlobsStageBlockResponse> stageBlockWithRestResponse(String containerName,
                                                                   String blobName,
                                                                   String base64BlockId,
                                                                   byte[] blockContent,
                                                                   byte[] contentMd5,
     ...
     */
    public ServiceCallTask<BlockBlobItem> commitBlockList(String containerName,
                                         String blobName,
     ...
     * @return The response object.
     */
    public ServiceCallTask<BlockBlobsCommitBlockListResponse> commitBlockListWithRestResponse(String containerName,
                                                                             String blobName,
                                                                             List<String> base64BlockIds,
                                                                             byte[] contentMD5,
                                                                             byte[] contentCrc64,
