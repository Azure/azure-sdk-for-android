...
import com.azure.android.core.util.paging.DefaultPaginationDescription;
import com.azure.android.core.util.paging.PageItemsFetcher;
import com.azure.android.core.util.paging.PaginationDescription;
...
import com.azure.android.core.util.tokenrequest.TokenRequestObservable;
import com.azure.android.core.util.tokenrequest.TokenRequestObservableAuthInterceptor;
...
final class ContainerBlobsPaginationRepository
    ...
    ContainerBlobsPaginationRepository(StorageBlobClient storageBlobClient, PaginationOptions paginationOptions) {
        ...
        final String storageBlobUrl = storageBlobClient.getBlobUrl();
