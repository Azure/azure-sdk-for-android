# Azure Core Serde shared library for Android
...
Azure Core Serde provides shared primitives, abstractions, and helpers for Serialization and Deserialization in Android Azure SDK client libraries.
...
[//]: # ({x-version-update-start;com.azure:azure-core-serde;current})
```xml
<dependency>
  <groupId>com.azure</groupId>
  <artifactId>azure-core-serde</artifactId>
...
The key concepts of Azure Core Serde include:
