...
public interface SerdeAdapter {
     ...
     */
    String serialize(Object object, SerdeEncoding encoding) throws IOException;
     ...
     * @throws IOException exception from serialization
     */
    default void serialize(final Object object, final SerdeEncoding encoding, OutputStream outputStream)
        throws IOException {
     ...
     */
    String serializeList(List<?> list, SerdeCollectionFormat format);
     ...
     */
    <T> T deserialize(String value, Type type, SerdeEncoding encoding) throws IOException;
     ...
     * @throws IOException exception from deserialization
     */
    default <T> T deserialize(final InputStream inputStream, final Type type, final SerdeEncoding encoding)
        throws IOException {
        if (inputStream == null) {
     ...
     */
    <T> T deserialize(Map<String, String> headers, Type type) throws IOException;
}
