...
public @interface SerdeTypeInfo {
     ...
     * Used for standard metadata types, except for {@link SerdeTypeInfo.Id#NONE}.
     */
    enum As {
        /**
     ...
     */
    SerdeTypeInfo.Id use();

    /**
     * Specifies mechanism to use for including type metadata (if any; for
     * {@link SerdeTypeInfo.Id#NONE} nothing is included); used when serializing,
     * and expected when deserializing.
     *
     * @return metadata type inclusion mechanism.
     */
    SerdeTypeInfo.As include() default SerdeTypeInfo.As.PROPERTY;

    /**
     * Property names used when type inclusion method ({@link SerdeTypeInfo.As#PROPERTY}).
     *
