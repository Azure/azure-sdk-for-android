...
final class CFStringPageRetriever
    ...
    public CFStringPageRetriever(int pageSize, int pageCount) {
        this.pageSize = pageSize;
        this.pageCount = pageCount;
        this.throwOnPageId = null;
    }

    public CFStringPageRetriever(int pageSize, int pageCount, int throwOnPageId) {
    ...
    @Override
    public CompletableFuture<PagedResponse<String>> call(String pageId) {
