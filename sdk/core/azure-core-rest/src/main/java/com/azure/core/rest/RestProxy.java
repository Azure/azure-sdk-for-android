...
import com.azure.core.rest.annotation.ResumeOperation;
...
import com.azure.core.rest.implementation.AccessibleByteArrayOutputStream;
...
import com.azure.core.rest.implementation.HttpResponseDecoder;
import com.azure.core.rest.implementation.HttpResponseDecoder.HttpDecodedResponse;
...
import com.azure.core.micro.util.tracing.TracerProxy;
...
public final class RestProxy implements InvocationHandler {
     ...
     * @param serdeAdapter the serializer that will be used to convert response bodies to POJOs.
     * @param interfaceParser the parser that contains information about the interface describing REST API methods that
     * this RestProxy "implements".
     */
    private RestProxy(HttpPipeline httpPipeline, SerdeAdapter serdeAdapter, SwaggerInterfaceParser interfaceParser) {
        this.httpPipeline = httpPipeline;
        this.serdeAdapter = serdeAdapter;
        this.interfaceParser = interfaceParser;
        this.decoder = new HttpResponseDecoder(this.serdeAdapter);
...
//                        + "type correctly specified in its service interface"));
            ...
            if (isJson) {
                ...
                serdeAdapter.serialize(bodyContentObject, SerdeEncoding.JSON, stream);
            ...
            } else if (isFluxByteBuffer(methodParser.getBodyJavaType())) {
                ...
                ByteArrayOutputStream stream = new AccessibleByteArrayOutputStream();
                serdeAdapter.serialize(bodyContentObject,
                    SerdeEncoding.fromHeaders(request.getHeaders().toMap()), stream);
    ...
    private Mono<?> handleBodyReturnType(final HttpDecodedResponse response,
        ...
        } else if (isFluxByteBuffer(entityType)) {
    ...
    private Object handleRestReturnType(final Mono<HttpDecodedResponse> asyncHttpDecodedResponse,
        ...
        } else if (isFluxByteBuffer(returnType)) {
...
//    }
    ...
    public static <A> A create(Class<A> swaggerInterface, HttpPipeline httpPipeline, SerdeAdapter serdeAdapter) {
        ...
        final RestProxy restProxy = new RestProxy(httpPipeline, serdeAdapter, interfaceParser);
     ...
     */
    private static boolean isFluxByteBuffer(Type entityType) {
...
//    /**
//     * Create an instance of the default serde adapter.
//     *
//     * @return the default serde adapter
//     */
//    private static SerdeAdapter createDefaultSerdeAdapter() {
//        return JacksonSerderAdapter.createDefaultSerdeAdapter();
//    }
...
//        return create(swaggerInterface, createDefaultPipeline(), createDefaultSerdeAdapter());
//    }
//
//    /**
//     * Create a proxy implementation of the provided Swagger interface.
...
//        return create(swaggerInterface, httpPipeline, createDefaultSerdeAdapter());
//    }
}
