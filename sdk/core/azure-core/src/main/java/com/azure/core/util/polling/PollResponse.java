...
public final class PollResponse<T> {
     ...
     */
    public  PollResponse(OperationStatus status, T value, Integer retryAfter, Map<Object, Object> properties) {
     ...
     * @throws NullPointerException If {@code status} is {@code null}.
     */
    public PollResponse(OperationStatus status, T value, Integer retryAfter) {
