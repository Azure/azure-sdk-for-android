 ...
 * "additionalProperties" with serialized name empty ("") of type Map&lt;String, Object&gt;, all items in this map
 * will become top level properties for this complex type.
 */
final class AdditionalPropertiesSerializer extends StdSerializer<Object> implements ResolvableSerializer {
    ...
    /**
     * Creates an instance of {@link FlatteningSerializer}.
     *
