...
public class Configuration implements Cloneable {
    ...
    /**
     * Constructs a configuration containing the known Azure properties constants and properties from an InputStream
     * that reads from a .properties file.
     *
     * @param inputStream An input stream created from a .properties file
     * @throws IOException If the given InputStream could not be read from.
     */
    ...
    private String load(String name) {
        // TODO: Evaluate loading from other places besides a .properties file.
        return loadFromProperties(name);
    }
