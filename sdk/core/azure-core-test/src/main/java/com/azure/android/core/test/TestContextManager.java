...
public class TestContextManager {
     ...
     * @param unitTestOutDir The output directory where UT artifacts are stored.
     * @param testMode The {@link TestMode} the test is running in.
     */
    public TestContextManager(Method testMethod, URL unitTestOutDir, TestMode testMode) {
     ...
     *
     * @return The output directory where UT artifacts are stored.
     */
    public URL getUnitTestOutDir() {
        return this.unitTestOutDir;
    }
