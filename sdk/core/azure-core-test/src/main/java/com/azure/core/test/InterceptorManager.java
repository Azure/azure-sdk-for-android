...
public class InterceptorManager implements AutoCloseable {
     ...
     */
    @Deprecated
    public InterceptorManager(String testName, URL unitTestOutDir, TestMode testMode) {
        this(testName, testName, unitTestOutDir, testMode, false);
    }
    ...
    private InterceptorManager(String testName, String playbackRecordName, URL unitTestOutDir, TestMode testMode, boolean doNotRecord) {
...
//     */
//    @Deprecated
//    public InterceptorManager(String testName, URL unitTestOutDir, Map<String, String> textReplacementRules, boolean doNotRecord) {
