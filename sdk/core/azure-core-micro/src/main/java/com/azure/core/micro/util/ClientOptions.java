 ...
 * The {@code applicationId} is used to configure UserAgentPolicy for telemetry/monitoring purpose. It can be
...
public final class ClientOptions {
    ...
    /**
     * Sets the applicationId provided. The {@code applicationId} is used to configure UserAgentPolicy for
