...
package com.azure.core.micro.util;
...
//
    ...
    /**
     * Gets the content of the provided ByteBuffer as a byte array. This method will create a new byte array even if
     * the ByteBuffer can have optionally backing array.
     *
...
//     * <p>
//     * Given that {@link InputStream} is not guaranteed to be replayable the returned {@link Flux} should be
//     * considered
...
//            // volatile ensures that writes to these fields by one thread will be immediately visible to other
//            // threads.
