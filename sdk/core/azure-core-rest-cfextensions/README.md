# Azure Core REST CompletableFuture extension library for Android
...
<dependency>
    ...
    <artifactId>azure-core-rest-cfextensions</artifactId>
...
The key concepts of Azure Core REST CompletableFuture extension include:
