# Azure Core custom Serde Jackson library for Android
...
Azure Core custom Serde implementation for Jackson. Custom Serde is for serializing and deserializing user defined models that Azure libraries usually know nothing about until runtime.
...
[//]: # ({x-version-update-start;com.azure:azure-core-customserde;current})
```xml
<dependency>
  <groupId>com.azure</groupId>
  <artifactId>azure-core-customserde-json-jackson</artifactId>
