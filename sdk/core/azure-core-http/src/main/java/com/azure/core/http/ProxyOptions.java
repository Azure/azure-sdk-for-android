...
// TODO: Investigate that whether the config concept appliable for android.
//
//    ----
...
//     * @return A {@link ProxyOptions} reflecting a proxy loaded from the environment, if no proxy is found
//     * {@code null}
//     * will be returned.
...
//        if (Util.isNullOrEmpty(proxyConfiguration)) {
//            return null;
//        }
//
//        try {
