...
public class UserAgentPolicy implements HttpPipelinePolicy {
     ...
     *
     * <p>The {@code chain.getRequest().getContext} will be checked for {@code Override-User-Agent}
     * and {@code Append-User-Agent}.
    ...
    public void process(HttpPipelinePolicyChain chain) {
        ...
        //  String overrideUserAgent = (String) httpRequest.getContext().getData(OVERRIDE_USER_AGENT_CONTEXT_KEY)
        //      .orElse(null);
        //  String appendUserAgent = (String) httpRequest.getContext().getData(APPEND_USER_AGENT_CONTEXT_KEY)
        //      .orElse(null);
        ...
        HttpRequest httpRequest = chain.getRequest();
        httpRequest.getHeaders().put(USER_AGENT, userAgent);
