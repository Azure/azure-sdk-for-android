...
/**
 * This class provides a fluent builder API to help aid the configuration and instantiation
 * of the {@link HttpPipeline}, calling {@link HttpPipelineBuilder#build() build}
...
public class HttpPipelineBuilder {
    ...
    /**
     *  Creates a new instance of HttpPipelineBuilder that can configure options for
     *  the {@link HttpPipeline} before creating an instance of it.
     */
    ...
    public HttpPipeline build() {
        List<HttpPipelinePolicy> policies = (pipelinePolicies == null)
            ? new ArrayList<>() : pipelinePolicies;
        com.azure.android.core.http.HttpClient client = (httpClient == null)
            ? HttpClient.createDefault() : httpClient;
