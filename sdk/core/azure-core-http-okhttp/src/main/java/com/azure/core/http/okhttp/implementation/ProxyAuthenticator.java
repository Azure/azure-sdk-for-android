...
import static com.azure.core.http.util.AuthorizationChallengeHandler.PROXY_AUTHENTICATION_INFO;
import static com.azure.core.http.util.AuthorizationChallengeHandler.PROXY_AUTHORIZATION;
...
public final class ProxyAuthenticator implements Authenticator {
    ...
    public Request authenticate(Route route, Response response) {
        ...
        if (!Util.isNullOrEmpty(authorizationHeader)) {
