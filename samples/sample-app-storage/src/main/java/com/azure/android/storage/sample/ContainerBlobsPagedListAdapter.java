...
public class ContainerBlobsPagedListAdapter
    ...
    private StorageBlobAsyncClient storageBlobAsyncClient;

    protected ContainerBlobsPagedListAdapter(StorageBlobAsyncClient storageBlobAsyncClient, Runnable retryRunnable) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case R.layout.blob_item:
                return BlobItemViewHolder.create(parent, storageBlobAsyncClient);
