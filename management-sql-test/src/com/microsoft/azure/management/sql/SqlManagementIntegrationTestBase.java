...
import com.microsoft.azure.management.storage.models.GeoRegionNames;
...
public abstract class SqlManagementIntegrationTestBase extends TestCase {
    ...
    protected static String getStorageKey(String storageAccountName) throws IOException, ServiceException, ParserConfigurationException, SAXException, URISyntaxException, DatatypeConfigurationException, XmlPullParserException {
    ...
    protected String createServer() throws ParserConfigurationException, SAXException, TransformerException, IOException, ServiceException, DatatypeConfigurationException, XmlPullParserException {
    ...
    protected String createDatabase(String serverName) throws ParserConfigurationException, SAXException, TransformerException, IOException, ServiceException, DatatypeConfigurationException, XmlPullParserException {
