...
public class SqlServerIntegrationTest extends SqlManagementIntegrationTestBase {
    ...
    public void testCreateSqlServerWithRequiredParameters() throws ParserConfigurationException, SAXException, TransformerException, IOException, ServiceException, DatatypeConfigurationException, XmlPullParserException {
        //arrange 
    ...
    public void testDeleteServerSuccess() throws ParserConfigurationException, SAXException, TransformerException, IOException, ServiceException, DatatypeConfigurationException, XmlPullParserException {
        //arrange 
        String testAdministratorUserName = "testadminname";
        String testPassword = "testpassword8!";
        String testLocation = "West US";
