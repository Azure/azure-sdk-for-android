...
import com.microsoft.azure.core.ISO8601DateConverter;
...
public class ISO8601DateConverterTests extends TestCase {
    public void testShortFormatWorks() throws Exception {
        // Arrange
    ...
    public void testLongFormatWorks() throws Exception {
        // Arrange
        ISO8601DateConverter converter = new ISO8601DateConverter();
    ...
    public void testMixedFormatWorks() throws Exception {
        // Arrange
        ISO8601DateConverter converter = new ISO8601DateConverter();
    ...
    public void testShortFormatRoundTrips() throws Exception {
        // Arrange
        ISO8601DateConverter converter = new ISO8601DateConverter();
        String value = "2012-01-12T00:35:58Z";
