...
public interface GatewayOperations {
    ...
    * request ID.
    */
    GatewayGetResponse get(String networkName) throws MalformedURLException, ProtocolException, ServiceException, IOException, XmlPullParserException, DatatypeConfigurationException;
    ...
    * Gateway.
    */
    GatewayListConnectionsResponse listConnections(String networkName) throws MalformedURLException, ProtocolException, ServiceException, IOException, XmlPullParserException, DatatypeConfigurationException;
