...
import com.microsoft.azure.management.util.TestRequestFilter;
import com.microsoft.azure.management.util.TestResponseFilter;

public class ManagementClientTests extends ManagementIntegrationTestBase { 

    public void testCreateWithRequestFilterLast() throws Exception {
    ...
    public void testCreateWithRequestLastRespectsOrder() throws Exception {
        // reinitialize configuration from known state
        Configuration config = createConfiguration();
        managementClient = ManagementService.create(config);
    ...
    public void testCreateWithRequestFirstRespectsOrder() throws Exception {
        // reinitialize configuration from known state
        Configuration config = createConfiguration();
        managementClient = ManagementService.create(config);
    ...
    public void testCreateWithResponseLastRespectsOrder() throws Exception {
        // reinitialize configuration from known state
        Configuration config = createConfiguration();
        managementClient = ManagementService.create(config);
    ...
    public void testCreateWithResponseFirstRespectsOrder() throws Exception {
        // reinitialize configuration from known state
        Configuration config = createConfiguration();
        managementClient = ManagementService.create(config);
