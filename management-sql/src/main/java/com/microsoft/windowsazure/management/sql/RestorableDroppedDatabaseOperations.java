...
public interface RestorableDroppedDatabaseOperations {
    ...
    * request.
    */
    RestorableDroppedDatabaseGetResponse get(String serverName, String entityId) throws MalformedURLException, ProtocolException, ServiceException, IOException, ParserConfigurationException, SAXException;
    ...
    * request.
    */
    RestorableDroppedDatabaseListResponse list(String serverName) throws MalformedURLException, ProtocolException, ServiceException, IOException, ParserConfigurationException, SAXException;
