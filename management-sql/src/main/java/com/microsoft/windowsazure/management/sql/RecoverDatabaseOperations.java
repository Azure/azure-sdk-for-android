...
public interface RecoverDatabaseOperations {
    ...
    * request.
    */
    RecoverDatabaseOperationCreateResponse create(String targetServerName, RecoverDatabaseOperationCreateParameters parameters) throws MalformedURLException, ProtocolException, ParserConfigurationException, SAXException, TransformerException, ServiceException, IOException;
