...
public interface RecoverableDatabaseOperations {
    ...
    */
    RecoverableDatabaseGetResponse get(String targetServerName, String sourceServerName, String sourceDatabaseName) throws MalformedURLException, ProtocolException, ServiceException, IOException, ParserConfigurationException, SAXException;
    ...
    */
    RecoverableDatabaseListResponse list(String targetServerName, String sourceServerName) throws MalformedURLException, ProtocolException, ServiceException, IOException, ParserConfigurationException, SAXException;
